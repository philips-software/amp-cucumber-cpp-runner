...
if(CCR_FETCH_DEPS)
    ...
    find_package(cucumber_pretty_formatter ${CUCUMBER_PRETTY_FORMATTER_VERSION} REQUIRED)
    find_package(cucumber_cucumber_expressions ${CUCUMBER_CUCUMBER_EXPRESSIONS_VERSION} REQUIRED)
endif()
