...
@test "Successful test" {
    run $acceptance_test --format summary pretty --tags "@result:OK" -- cucumber_cpp/acceptance_test/features
    assert_success
}

@test "Parse tag expression" {
    run $acceptance_test --format summary pretty --tags "@smoke and @result:OK" -- cucumber_cpp/acceptance_test/features
    assert_success
}

@test "Failed tests" {
    run $acceptance_test --format summary pretty --tags "@result:FAILED" -- cucumber_cpp/acceptance_test/features
    assert_failure
}

@test "Undefined tests" {
    run $acceptance_test --format summary pretty --tags "@result:UNDEFINED" -- cucumber_cpp/acceptance_test/features
    assert_failure
...
@test "No tests" {
    run $acceptance_test --format summary pretty --tags "@invalidtag" -- cucumber_cpp/acceptance_test/features
    assert_success
}
...
@test "Run Scenario hooks" {
    run $acceptance_test --format summary pretty --tags @bats and @scenariohook and not @stephook -- cucumber_cpp/acceptance_test/features
    assert_success
...
@test "Run Step hooks" {
    run $acceptance_test --format summary pretty --tags @bats and @stephook and not @scenariohook -- cucumber_cpp/acceptance_test/features
    assert_success
...
@test "Run Scenario and Step hooks" {
    run $acceptance_test --format summary pretty --tags "@bats and (@scenariohook or @stephook)" -- cucumber_cpp/acceptance_test/features
    assert_success
...
@test "Dry run with known failing steps" {
    ...
    run $acceptance_test --format summary pretty --tags "@result:FAILED" --dry-run cucumber_cpp/acceptance_test/features
    assert_success
}
...
@test "Dry run with known missing steps" {
    ...
    run $acceptance_test --format summary pretty --tags "@result:UNDEFINED" --dry-run  cucumber_cpp/acceptance_test/features
    assert_success
    assert_output --partial "UNDEFINED Given a missing step"
}

@test "Test the and keyword" {
    run $acceptance_test --format summary pretty --tags "@keyword-and" -- cucumber_cpp/acceptance_test/features
    assert_success
...
@test "Test the but keyword" {
    run $acceptance_test --format summary pretty --tags "@keyword-but" -- cucumber_cpp/acceptance_test/features
    assert_success
    assert_output --partial "--when--"
...
@test "Test the asterisk keyword" {
    run $acceptance_test --format summary pretty --tags "@keyword-asterisk" -- cucumber_cpp/acceptance_test/features
...
@test "Test passing scenario after failed scenario reports feature as failed" {
    run $acceptance_test --format summary pretty  --tags "@fail_feature" -- cucumber_cpp/acceptance_test/features
    assert_failure
    assert_output --partial "2 scenarios"
...
@test "Test failing hook before results in error" {
    run $acceptance_test --format summary pretty  --tags "@fail_scenariohook_before" -- cucumber_cpp/acceptance_test/features
    assert_failure
    assert_output --partial "FAILED Before"
}

@test "Test failing hook after results in error" {
    run $acceptance_test --format summary pretty  --tags "@fail_scenariohook_after" -- cucumber_cpp/acceptance_test/features
    assert_failure
    assert_output --partial "FAILED After"
}

@test "Test throwing hook results in error" {
    run $acceptance_test --format summary pretty  --tags "@throw_scenariohook" -- cucumber_cpp/acceptance_test/features
    assert_failure
    assert_output --partial "FAILED Before"
}

@test "Test error program hook results in error and skipped steps" {
    run $acceptance_test.custom --format summary pretty --tags "@smoke and @result:OK" --required --failprogramhook cucumber_cpp/acceptance_test/features
    assert_failure
    assert_output --partial "HOOK_BEFORE_ALL"
    assert_output --partial "HOOK_AFTER_ALL"
...
@test "Test unicode" {
    run $acceptance_test --format summary pretty --tags "@unicode" -- cucumber_cpp/acceptance_test/features
    assert_success
...
#     run $acceptance_test --format summary pretty --tags "@unused_steps" --report cucumber_cpp/acceptance_test/features
#     assert_success
...
@test "Test unused steps by default not reported" {
    run $acceptance_test --format summary pretty --tags "@unused_steps" -- cucumber_cpp/acceptance_test/features
    assert_success
