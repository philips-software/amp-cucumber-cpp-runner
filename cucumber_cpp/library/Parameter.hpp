...
#define PARAMETER_BODY(Type, Info, Args)                                                                                                                                                                                          \
    ...
    {                                                                                                                                                                                                                             \
        ...
        {                                                                                                                                                                                                                         \
            static std::optional<Type> Transform(const cucumber::cucumber_expressions::ConvertFunctionArg& group)                                                                                                                 \
            {                                                                                                                                                                                                                     \
                return TransformFn(group, static_cast<void(*) Args>(nullptr));                                                                                                                                                    \
            }                                                                                                                                                                                                                     \
                                                                                                                                                                                                                                  \
            template<class... TArgs>                                                                                                                                                                                              \
            static std::optional<Type> TransformFn(const cucumber::cucumber_expressions::ConvertFunctionArg& group, void (* /* unused */)(TArgs...))                                                                              \
            {                                                                                                                                                                                                                     \
                return TransformFn<TArgs...>(group, std::make_index_sequence<sizeof...(TArgs)>{});                                                                                                                                \
            }                                                                                                                                                                                                                     \
                                                                                                                                                                                                                                  \
            template<class... TArgs, std::size_t... I>                                                                                                                                                                            \
            static std::optional<Type> TransformFn(const cucumber::cucumber_expressions::ConvertFunctionArg& group, std::index_sequence<I...> /*unused*/)                                                                         \
            {                                                                                                                                                                                                                     \
    ...
    const std::size_t PARAMETER_STRUCT::ID = cucumber_cpp::library::support::DefinitionRegistration::Instance().Register<PARAMETER_STRUCT, std::optional<Type>>(cucumber::cucumber_expressions::CustomParameterEntryParams Info); \
