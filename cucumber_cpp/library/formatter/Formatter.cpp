...
{
    Formatter::Formatter(support::SupportCodeLibrary& supportCodeLibrary, query::Query& query, const helper::EventDataCollector& eventDataCollector, const nlohmann::json& formatOptions, std::ostream& outputStream)
